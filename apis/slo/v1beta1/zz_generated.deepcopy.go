...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WatchSLO) DeepCopyInto(out *WatchSLO) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WatchSLO.
func (in *WatchSLO) DeepCopy() *WatchSLO {
	if in == nil {
		return nil
	}
	out := new(WatchSLO)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *WatchSLO) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WatchSLOList) DeepCopyInto(out *WatchSLOList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]WatchSLO, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WatchSLOList.
func (in *WatchSLOList) DeepCopy() *WatchSLOList {
	if in == nil {
		return nil
	}
	out := new(WatchSLOList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *WatchSLOList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WatchSLOSpec) DeepCopyInto(out *WatchSLOSpec) {
	*out = *in
	if in.Configs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WatchSLOSpec.
func (in *WatchSLOSpec) DeepCopy() *WatchSLOSpec {
	if in == nil {
		return nil
	}
	out := new(WatchSLOSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WatchSLOStatus) DeepCopyInto(out *WatchSLOStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WatchSLOStatus.
func (in *WatchSLOStatus) DeepCopy() *WatchSLOStatus {
	if in == nil {
		return nil
	}
	out := new(WatchSLOStatus)
	in.DeepCopyInto(out)
	return out
}
